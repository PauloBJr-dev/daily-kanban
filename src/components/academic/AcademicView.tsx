...
export const AcademicView: React.FC = () => {
  ...
  const handleOpenEditNote = useCallback((note: AcademicNote) => {
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-slate-200/80 dark:border-slate-800">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
            Organize suas matérias, conceitos de estudo, datas de prova e cronograma de
            revisões.
          </p>
        </div>
          ...
          <div className="p-12 text-center rounded-3xl bg-white dark:bg-slate-900 border border-dashed border-slate-200 dark:border-slate-800 flex flex-col items-center justify-center max-w-lg mx-auto my-6 shadow-xs">
            {hasActiveFilters ? (
              ...
              <>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 max-w-xs">
                  Comece registrando seus primeiros resumos, fórmulas e tópicos de estudo.
                </p>
