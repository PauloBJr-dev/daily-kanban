      ...
      <div className="flex items-center justify-between px-2 py-2 mb-2">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="p-1 rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-white/80 dark:hover:bg-slate-800 transition-colors"
          >
          ...
          {allColumns.length > 2 && onDeleteColumn && (
            <button
              ...
              className="p-1 rounded-lg text-slate-300 hover:text-rose-500 hover:bg-white/80 dark:hover:bg-slate-800 transition-colors"
            >
      ...
      <div className="flex-1 flex flex-col gap-3 min-h-[140px] overflow-y-auto pr-0.5">
        ...
        {tasks.length === 0 && (
          <div className="flex-1 flex flex-col items-center justify-center p-6 border-2 border-dashed border-slate-200/70 dark:border-slate-800/80 rounded-2xl text-center select-none">
            ...
            <button
              onClick={() => onNewTaskInColumn(column.id)}
              className="mt-2 text-xs text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 font-medium flex items-center gap-1"
            >
